...
public class ModuleCapabilityResponse {
  ...
  public ModuleCapabilityResponse(String type, Double collectionFrequency,
      Double requiredUpdateFrequency, Integer minRequiredReadingsOnUpdate) {
    this.type = type;
  ...
  public String toString() {
    return "ModuleCapabilityResponse{" + "type='" + type + '\'' + ", collectionFrequency="
        + collectionFrequency + ", requiredUpdateFrequency=" + requiredUpdateFrequency
