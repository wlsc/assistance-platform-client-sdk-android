...
public class ProfileResponse {
  ...
  public ProfileResponse(String firstname, String lastname, String primaryEmail, Long lastLogin,
      Long joinedSince, List<UserSocialService> socialServices) {
  ...
  public String toString() {
    return "ProfileResponse{" + "firstname='" + firstname + '\'' + ", lastname='" + lastname + '\''
        + ", primaryEmail='" + primaryEmail + '\'' + ", lastLogin=" + lastLogin + ", joinedSince="
        + joinedSince + ", socialServices=" + socialServices + '}';
  }
}
