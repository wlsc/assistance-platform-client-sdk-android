...
public class ModuleListServerResource extends ServerResource {
    ...
    public String represent(String json){
		...
		module3.setDescriptionFull("This is second edition of very famous Hotzones module! There are a lot of new feature avaiable for you!");
		module3.setLogo("https://cdn1.iconfinder.com/data/icons/basic-ui-elements-round/700/09_location_pin-2-512.png");
