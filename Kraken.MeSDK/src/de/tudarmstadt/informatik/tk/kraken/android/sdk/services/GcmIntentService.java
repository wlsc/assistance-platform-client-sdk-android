...
import de.tudarmstadt.informatik.tk.kraken.android.sdk.receivers.GcmBroadcastReceiver;
...
public class GcmIntentService extends IntentService {
    ...
    private void handleMessage(Bundle message) {
        if(!message.containsKey("msgType")) {
            return;
        }

        switch (message.getString("msgType", null)) {
