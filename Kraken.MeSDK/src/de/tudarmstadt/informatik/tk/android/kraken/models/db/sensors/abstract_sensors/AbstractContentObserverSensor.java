package de.tudarmstadt.informatik.tk.android.kraken.models.db.sensors.abstract_sensors;
...
public abstract class AbstractContentObserverSensor extends AbstractSensor {
	...
	private class SyncTimer extends TimerTask {
		@Override
		public void run() {
			System.out.println("syning now!");

            m_daoSession.runInTx(new Runnable() {
                @Override
                public void run() {
                    syncData();
                }
