...
/** 
 * DAO for table SENSOR_CALENDAR_EVENT.
*/
public class SensorCalendarEventDao extends AbstractDao<SensorCalendarEvent, Long> {

    public static final String TABLENAME = "SENSOR_CALENDAR_EVENT";

    /**
     * Properties of entity SensorCalendarEvent.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Timestamp = new Property(23, Long.class, "timestamp", false, "TIMESTAMP");
        public final static Property IsNew = new Property(24, Boolean.class, "isNew", false, "IS_NEW");
        public final static Property IsUpdated = new Property(25, Boolean.class, "isUpdated", false, "IS_UPDATED");
        public final static Property IsDeleted = new Property(26, Boolean.class, "isDeleted", false, "IS_DELETED");
    };


    public SensorCalendarEventDao(DaoConfig config) {
        super(config);
    }
    
    public SensorCalendarEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SENSOR_CALENDAR_EVENT' (" + //
                ...
                "'TITLE' TEXT," + // 22: title
                "'TIMESTAMP' INTEGER," + // 23: timestamp
                "'IS_NEW' INTEGER," + // 24: isNew
                "'IS_UPDATED' INTEGER," + // 25: isUpdated
                "'IS_DELETED' INTEGER);"); // 26: isDeleted
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SENSOR_CALENDAR_EVENT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SensorCalendarEvent entity) {
        stmt.clearBindings();
        ...
        if (isUpdated != null) {
            stmt.bindLong(26, isUpdated ? 1l: 0l);
        }
 
        Boolean isDeleted = entity.getIsDeleted();
        if (isDeleted != null) {
            stmt.bindLong(27, isDeleted ? 1l: 0l);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public SensorCalendarEvent readEntity(Cursor cursor, int offset) {
        SensorCalendarEvent entity = new SensorCalendarEvent( //
            ...
            cursor.isNull(offset + 25) ? null : cursor.getShort(offset + 25) != 0, // isUpdated
            cursor.isNull(offset + 26) ? null : cursor.getShort(offset + 26) != 0 // isDeleted
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SensorCalendarEvent entity, int offset) {
        ...
        entity.setIsUpdated(cursor.isNull(offset + 25) ? null : cursor.getShort(offset + 25) != 0);
        entity.setIsDeleted(cursor.isNull(offset + 26) ? null : cursor.getShort(offset + 26) != 0);
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SensorCalendarEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SensorCalendarEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
