...
*/
public class MotionActivityEventDao extends AbstractDao<MotionActivityEvent, Long> {
    ...
    */
    ...
    public MotionActivityEventDao(DaoConfig config) {
        super(config);
    }
    
    public MotionActivityEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MotionActivityEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MotionActivityEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
