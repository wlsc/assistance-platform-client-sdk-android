...
/** 
 * DAO for table SENSOR_FOREGROUND_EVENT.
*/
public class SensorForegroundEventDao extends AbstractDao<SensorForegroundEvent, Long> {

    public static final String TABLENAME = "SENSOR_FOREGROUND_EVENT";

    /**
     * Properties of entity SensorForegroundEvent.<br/>
    ...
    */
    ...
    public SensorForegroundEventDao(DaoConfig config) {
        super(config);
    }
    
    public SensorForegroundEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SENSOR_FOREGROUND_EVENT' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SENSOR_FOREGROUND_EVENT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SensorForegroundEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SensorForegroundEvent readEntity(Cursor cursor, int offset) {
        SensorForegroundEvent entity = new SensorForegroundEvent( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SensorForegroundEvent entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SensorForegroundEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SensorForegroundEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
