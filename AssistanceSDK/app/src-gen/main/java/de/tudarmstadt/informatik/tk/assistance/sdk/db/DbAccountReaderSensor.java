 ...
 */
@Entity(active = true, nameInDb = "account_reader_sensor")
public class DbAccountReaderSensor implements de.tudarmstadt.informatik.tk.assistance.sdk.interfaces.IDbSensor {
    ...
    @Generated
    private transient DbAccountReaderSensorDao myDao;
    ...
    @Generated
    public DbAccountReaderSensor(Long id, String types, String created, Long deviceId) {
        this.id = id;
        this.types = types;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getDbAccountReaderSensorDao() : null;
    }
