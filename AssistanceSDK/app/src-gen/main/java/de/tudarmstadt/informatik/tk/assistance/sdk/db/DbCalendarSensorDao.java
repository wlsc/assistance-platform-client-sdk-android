...
public class DbCalendarSensorDao extends AbstractDao<DbCalendarSensor, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbCalendarSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbCalendarSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbCalendarSensor entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbCalendarSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
