...
public class DbUserSocialProfileDao extends AbstractDao<DbUserSocialProfile, Long> {
    ...
    */
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbUserSocialProfile entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbUserSocialProfile entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbUserSocialProfile entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbUserSocialProfile entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
