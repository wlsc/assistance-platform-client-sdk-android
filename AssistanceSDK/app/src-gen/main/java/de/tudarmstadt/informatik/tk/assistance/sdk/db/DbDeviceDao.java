...
public class DbDeviceDao extends AbstractDao<DbDevice, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbDevice entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbDevice entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbDevice entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbDevice entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(DbDevice entity) {
