...
public class DbContactSensorDao extends AbstractDao<DbContactSensor, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbContactSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbContactSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbContactSensor entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbContactSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
