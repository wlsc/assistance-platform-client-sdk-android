...
public class DbRingtoneSensorDao extends AbstractDao<DbRingtoneSensor, Long> {
    ...
    public static class Properties {
        ...
        public static final Property Mode = new Property(1, Integer.class, "mode", false, "MODE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE INDEX " + constraint + "IDX_ringtone_sensor__id ON ringtone_sensor" +
                " (\"_id\");");
        db.execSQL("CREATE INDEX " + constraint + "IDX_ringtone_sensor_DEVICE_ID ON ringtone_sensor" +
                " (\"DEVICE_ID\");");
    }
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbRingtoneSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbRingtoneSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbRingtoneSensor entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbRingtoneSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM ringtone_sensor T");
    ...
    protected DbRingtoneSensor loadCurrentDeep(Cursor cursor, boolean lock) {
        DbRingtoneSensor entity = loadCurrent(cursor, 0, lock);
    ...
    public DbRingtoneSensor loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<DbRingtoneSensor> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<DbRingtoneSensor> list = new ArrayList<>(count);
    ...
    protected List<DbRingtoneSensor> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<DbRingtoneSensor> queryDeep(String where, String... selectionArg) {
