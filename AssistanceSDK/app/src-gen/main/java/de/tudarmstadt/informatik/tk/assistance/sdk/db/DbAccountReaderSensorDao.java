...
public class DbAccountReaderSensorDao extends AbstractDao<DbAccountReaderSensor, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbAccountReaderSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbAccountReaderSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbAccountReaderSensor entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbAccountReaderSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    public List<DbAccountReaderSensor> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<DbAccountReaderSensor> list = new ArrayList<>(count);
