 ...
 */
@Entity(active = true, nameInDb = "connection_sensor")
public class DbConnectionSensor implements de.tudarmstadt.informatik.tk.assistance.sdk.interfaces.IDbSensor {
    ...
    @Generated
    private transient DbConnectionSensorDao myDao;
    ...
    @Generated
    public DbConnectionSensor(Long id, Boolean isWifi, Boolean isMobile, String created, Long deviceId) {
        this.id = id;
        this.isWifi = isWifi;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getDbConnectionSensorDao() : null;
    }
