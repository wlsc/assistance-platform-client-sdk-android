...
public class DbCalendarReminderSensorDao extends AbstractDao<DbCalendarReminderSensor, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DbCalendarReminderSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DbCalendarReminderSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DbCalendarReminderSensor entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DbCalendarReminderSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(DbCalendarReminderSensor entity) {
