...
//        }
//
//        Map<Long, DbBrowserHistorySensor> allExistingHistory;
//        try {
...
//    private Map<Long, DbBrowserHistorySensor> getAllExistingHistory() throws
...
//            mMethodForGetAllExistingHistory = DbBrowserHistorySensor.class.getDeclaredMethod("getHistoryId");
...
//        setRunning(true);
    ...
    @Override
    public int getType() {
        return SensorApiType.BROWSER_HISTORY;
    }
