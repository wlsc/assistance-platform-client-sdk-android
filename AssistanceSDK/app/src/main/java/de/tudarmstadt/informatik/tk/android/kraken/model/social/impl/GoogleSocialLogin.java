...
public class GoogleSocialLogin extends AbstractSocialLogin implements SocialLogin {
	...
	private static GoogleSocialLogin m_instance;

	private GoogleSocialLogin() {
	}

	public static GoogleSocialLogin getInstance() {
		if (m_instance == null)
			m_instance = new GoogleSocialLogin();
		return m_instance;
	}
    ...
    public class GetTokenTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                String token = GoogleAuthUtil.getToken(m_ctxActivity, mEmail, GoogleSocialLogin.SCOPE);
