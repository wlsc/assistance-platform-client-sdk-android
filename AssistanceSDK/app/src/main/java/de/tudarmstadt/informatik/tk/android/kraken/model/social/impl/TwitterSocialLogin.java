...
public class TwitterSocialLogin extends AbstractSocialLogin implements SocialLogin {
	...
	private static TwitterSocialLogin m_instance;
	
	private TwitterSocialLogin()
	{
	}
	
	public static TwitterSocialLogin getInstance()
	{
		if (m_instance == null)
			m_instance = new TwitterSocialLogin();
		return m_instance;
	}
	...
	static final String TWITTER_CALLBACK_URL = "oauth://de.tudarmstadt.informatik.tk.android.kraken.login.twitter.Twitter_oAuth";
