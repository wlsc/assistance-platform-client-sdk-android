...
public class DbAccelerometerSensorDao extends AbstractDao<DbAccelerometerSensor, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbAccelerometerSensor entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbAccelerometerSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
