...
*/
public class DbConnectionEventDao extends AbstractDao<DbConnectionEvent, Long> {

    public static final String TABLENAME = "connection_event";

    /**
     * Properties of entity DbConnectionEvent.<br/>
    ...
    */
    ...
    public DbConnectionEventDao(DaoConfig config) {
        super(config);
    }
    
    public DbConnectionEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbConnectionEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DbConnectionEvent readEntity(Cursor cursor, int offset) {
        DbConnectionEvent entity = new DbConnectionEvent( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DbConnectionEvent entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbConnectionEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DbConnectionEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
