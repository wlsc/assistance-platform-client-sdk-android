...
/** 
 * DAO for table "network_traffic_event".
*/
public class DbNetworkTrafficEventDao extends AbstractDao<DbNetworkTrafficEvent, Long> {

    public static final String TABLENAME = "network_traffic_event";

    /**
     * Properties of entity DbNetworkTrafficEvent.<br/>
    ...
    */
    ...
    public DbNetworkTrafficEventDao(DaoConfig config) {
        super(config);
    }
    
    public DbNetworkTrafficEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"network_traffic_event\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_network_traffic_event__id ON network_traffic_event" +
                " (\"_id\");");
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"network_traffic_event\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbNetworkTrafficEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DbNetworkTrafficEvent readEntity(Cursor cursor, int offset) {
        DbNetworkTrafficEvent entity = new DbNetworkTrafficEvent( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DbNetworkTrafficEvent entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbNetworkTrafficEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DbNetworkTrafficEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
