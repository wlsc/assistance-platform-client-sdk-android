...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig dbPowerStatusEventDaoConfig;
    ...
    private final DbPowerStatusEventDao dbPowerStatusEventDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        dbPowerStatusEventDaoConfig = daoConfigMap.get(DbPowerStatusEventDao.class).clone();
        dbPowerStatusEventDaoConfig.initIdentityScope(type);
        ...
        dbPowerStatusEventDao = new DbPowerStatusEventDao(dbPowerStatusEventDaoConfig, this);
        ...
        registerDao(DbPowerStatusEvent.class, dbPowerStatusEventDao);
    }
    ...
    public void clear() {
        ...
        dbPowerStatusEventDaoConfig.getIdentityScope().clear();
    }
    ...
    public DbPowerStatusEventDao getDbPowerStatusEventDao() {
        return dbPowerStatusEventDao;
    }
