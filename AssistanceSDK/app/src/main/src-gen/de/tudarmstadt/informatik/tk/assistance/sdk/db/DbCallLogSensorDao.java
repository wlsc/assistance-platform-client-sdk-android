...
public class DbCallLogSensorDao extends AbstractDao<DbCallLogSensor, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbCallLogSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(DbCallLogSensor entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbCallLogSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    public List<DbCallLogSensor> loadAllDeepFromCursor(Cursor cursor) {
        ...
        List<DbCallLogSensor> list = new ArrayList<DbCallLogSensor>(count);
