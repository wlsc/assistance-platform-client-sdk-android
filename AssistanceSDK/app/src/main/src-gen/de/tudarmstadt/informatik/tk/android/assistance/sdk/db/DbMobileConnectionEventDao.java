...
*/
public class DbMobileConnectionEventDao extends AbstractDao<DbMobileConnectionEvent, Long> {

    public static final String TABLENAME = "mobile_connection_event";

    /**
     * Properties of entity DbMobileConnectionEvent.<br/>
    ...
    */
    ...
    public DbMobileConnectionEventDao(DaoConfig config) {
        super(config);
    }
    
    public DbMobileConnectionEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbMobileConnectionEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DbMobileConnectionEvent readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbMobileConnectionEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DbMobileConnectionEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
