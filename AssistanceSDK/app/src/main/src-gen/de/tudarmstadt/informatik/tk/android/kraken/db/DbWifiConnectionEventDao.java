...
*/
public class DbWifiConnectionEventDao extends AbstractDao<DbWifiConnectionEvent, Long> {

    public static final String TABLENAME = "wifi_connection_event";

    /**
     * Properties of entity DbWifiConnectionEvent.<br/>
    ...
    */
    ...
    public DbWifiConnectionEventDao(DaoConfig config) {
        super(config);
    }
    
    public DbWifiConnectionEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbWifiConnectionEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DbWifiConnectionEvent readEntity(Cursor cursor, int offset) {
        DbWifiConnectionEvent entity = new DbWifiConnectionEvent( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DbWifiConnectionEvent entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbWifiConnectionEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DbWifiConnectionEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
