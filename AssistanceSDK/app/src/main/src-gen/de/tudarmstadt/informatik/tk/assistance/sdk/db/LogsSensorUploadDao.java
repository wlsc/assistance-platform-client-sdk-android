...
public class LogsSensorUploadDao extends AbstractDao<LogsSensorUpload, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, LogsSensorUpload entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(LogsSensorUpload entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(LogsSensorUpload entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
