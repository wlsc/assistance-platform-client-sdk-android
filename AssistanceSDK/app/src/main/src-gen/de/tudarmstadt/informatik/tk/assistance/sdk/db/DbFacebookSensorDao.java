...
public class DbFacebookSensorDao extends AbstractDao<DbFacebookSensor, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbFacebookSensor entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(DbFacebookSensor entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbFacebookSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
