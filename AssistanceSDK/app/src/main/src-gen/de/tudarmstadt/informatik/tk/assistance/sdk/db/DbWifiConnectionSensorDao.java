...
public class DbWifiConnectionSensorDao extends AbstractDao<DbWifiConnectionSensor, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbWifiConnectionSensor entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbWifiConnectionSensor entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
