...
/** 
 * DAO for table "running_processes_event".
*/
public class DbRunningProcessesEventDao extends AbstractDao<DbRunningProcessesEvent, Long> {

    public static final String TABLENAME = "running_processes_event";

    /**
     * Properties of entity DbRunningProcessesEvent.<br/>
    ...
    */
    ...
    public DbRunningProcessesEventDao(DaoConfig config) {
        super(config);
    }
    
    public DbRunningProcessesEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"running_processes_event\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DbRunningProcessesEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DbRunningProcessesEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DbRunningProcessesEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
